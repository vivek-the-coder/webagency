    ...
    >
      ...
      >
        ...
        <div className="mt-8 sm:mt-12 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 relative z-10 w-full sm:w-auto">
          ...
          <button className="w-full sm:w-auto px-8 sm:px-10 py-3.5 sm:py-4 rounded-full border-2 border-foreground/20 bg-background/50 backdrop-blur-sm text-foreground font-bold text-base sm:text-lg hover:bg-foreground/5 active:bg-foreground/10 transition-all duration-300 touch-manipulation">
