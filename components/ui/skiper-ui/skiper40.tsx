...
const Skiper40 = () => {
  return (
    <section className="w-full h-full min-h-[300px] flex items-center justify-center overflow-hidden bg-background py-10">
      <div className="relative flex flex-col items-center justify-center gap-6 sm:gap-8 md:gap-10">
        <Link001 href="mailto:hi@skiper-ui.com" className="text-2xl sm:text-3xl md:text-5xl font-bold">hi@skiper-ui.com</Link001>
        <Link002 href="mailto:hi@skiper-ui.com" className="text-2xl sm:text-3xl md:text-5xl font-bold">hi@skiper-ui.com</Link002>
        <Link003 href="mailto:hi@skiper-ui.com" className="text-2xl sm:text-3xl md:text-5xl font-bold">hi@skiper-ui.com</Link003>
        <Link004 href="mailto:hi@skiper-ui.com" className="text-2xl sm:text-3xl md:text-5xl font-bold">hi@skiper-ui.com</Link004>
        <Link005 href="mailto:hi@skiper-ui.com" className="text-2xl sm:text-3xl md:text-5xl font-bold">hi@skiper-ui.com</Link005>
      </div>
    </section>
  );
};
